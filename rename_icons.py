...
au format : {numéro_pokédex}-b-n.png  (variante : -b-n-1.png, -b-n-2.png …)
...
ICONS_DIR = os.path.join(os.path.dirname(__file__), "assets", "sprite", "Icons")
    ...
    for base, entries in sorted(groups.items()):
        ...
        for f, variant, is_female, shadow in sorted(
            ...
            if variant is None and not is_female and not shadow:
                new_name = f"{dex_num}-b-n.png"
            elif variant is not None:
                new_name = f"{dex_num}-b-n-{variant}.png"
            elif is_female:
                new_name = f"{dex_num}-b-n-{female_counter}.png"
                female_counter += 1
                shadow_counter = female_counter
            elif shadow:
                new_name = f"{dex_num}-b-n-{shadow_counter}.png"
                shadow_counter += 1
